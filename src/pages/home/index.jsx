  ...
  return (
    <div className="bg-black text-white font-serif">
      ...
      <header className="flex flex-col md:flex-row justify-between items-center px-6 py-4 border-b border-gray-700">
        ...
        <nav className="flex justify-center gap-6 mt-4 md:mt-0 mx-auto">
      ...
      <section className="text-center px-6 py-20 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-6">
          <Link to="/menu" className="border border-white px-6 py-3 rounded-full font-semibold hover:bg-white hover:text-black transition">
            Explore nosso Menu
          </Link>
        </div>
      </section>
      ...
      <section className="px-6 py-16 bg-[#111] text-center">
